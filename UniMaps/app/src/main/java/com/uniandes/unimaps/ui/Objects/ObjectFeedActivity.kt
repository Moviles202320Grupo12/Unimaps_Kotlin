...
class ObjectFeedActivity : AppCompatActivity()  {
    ...
    override fun onResume() {
        ...
        coroutineScope.launch {
            try {
               ...
               val eventsList=dbEvents.values.toList()
                ...
                withContext(Dispatchers.Main) {
                    val adapter = ObjectAdapter(this@ObjectFeedActivity, events)
                    listViewEvents.adapter = adapter
                }
            ...
            {
                Log.e("TAG", "Error en la carga del BD de objetos: ${exception.message}")
            }
